...
<body>
    ...
    <div class="content-sort">
        ...
        <a href="/content/stream/" class="sort <?= $selected_category === null ? 'active' : '' ?>">همه</a>
        <a href="?category=game" class="sort <?= $selected_category === 'game' ? 'active' : '' ?>">بازی</a>
        <a href="?category=justchat" class="sort <?= $selected_category === 'justchat' ? 'active' : '' ?>">جاست چت</a>
        <a href="?category=dota2" class="sort <?= $selected_category === 'dota2' ? 'active' : '' ?>">دوتا 2</a>
        <a href="?category=warzone" class="sort <?= $selected_category === 'warzone' ? 'active' : '' ?>">وارزون</a>
    </div>

    <div class="content-list">
        <h1>برترین محتوا های استریمینگ</h1>
